...
const EditInternalExamSchedule = () => {
    ...
    try {
      ...
      if (selectedCourse && semester && year) {
        const response = await axiosPrivate.get(
          `/academic/getInternalExamTimeTable`,
          {
            params: {
  ...
  return (
    <div className="container mt-5">
      ...
      {editVisible ? (
        <>
          <h2 className="mb-4">
            Timetable {selectedName ? " - " + selectedName : null}
          </h2>
          <button
            type="button"
                ...
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <input
                      ...
                      value={entry.time}
                      onChange={(e) =>
                        handleAssignTiming(e.target.value, index)
                      }
                    />
                  </td>
                  <td>
          ...
          <div className="mb-3">
            <button className="btn btn-primary" onClick={handleModifyTimetable}>
              Modify TimeTable
            </button>
          </div>
        </>
...
export default EditInternalExamSchedule;
